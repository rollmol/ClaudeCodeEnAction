            ...
            <div className={cn(
              ...
              <div className={cn(
                ...
                <div className="text-sm">
                  <>
                    {(message.parts ?? []).map((part: UIMessagePart<UIDataTypes, UITools>, partIndex: number) => {
                      switch (part.type) {
                        case "text":
                        ...
                        case "reasoning":
                          return (
                            <div key={partIndex} className="mt-3 p-3 bg-white/50 rounded-md border border-neutral-200">
                              ...
                              <span className="text-sm text-neutral-700">{(part as any).text}</span>
                            </div>
                          );
                    ...
                    {isLoading &&
                      ...
                      (message.parts ?? []).every((p) => p.type !== "text" || !(p as any).text) && (
